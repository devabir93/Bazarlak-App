...
public class Products implements Parcelable
{
    ...
    protected Products(Parcel in) {
        ...
        in.readList(this.data, (uk.co.ribot.androidboilerplate.data.model.Product.class.getClassLoader()));
     ...
     * @param lastPageUrl
     */
    public Products(Integer currentPage, List<Product> data, String firstPageUrl, Integer from, Integer lastPage, String lastPageUrl, String nextPageUrl, String path, Integer perPage, Object prevPageUrl, Integer to, Integer total) {
        super();
