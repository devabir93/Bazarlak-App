...
# You can edit the include path and productOrder by changing the proguardFiles
...
-keepclassmembers class uk.co.ribot.androidboilerplate.userData.model.** {
...
-keepclassmembers class uk.co.ribot.androidboilerplate.userData.remote.BazarlakService$** {
    !static !private <fields>;
}
